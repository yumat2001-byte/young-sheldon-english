...
(function(){
  document.querySelectorAll('.version').forEach(v=>v.textContent='v3.13');
...
(function(){
  ...
  function accordionRow(w){
    ...
    return '<details class="review-word-accordion"><summary><span class="review-word-summary"><span class="review-word-main"><span class="list-word">'+w.w+'</span><span class="list-meaning">'+w.m+'</span></span><span class="review-chevron">⌄</span></span></summary><div class="review-word-panel"><div class="review-word-top"><div><div class="pron">'+w.p+'</div><div class="meaning">'+w.m+'</div></div><button class="review-speak" onclick="event.preventDefault();event.stopPropagation();speakText(\''+safeWord+'\')">🔊 発音</button></div>'+relatedHTML(w)+'<div class="example" onclick="speakText(\''+safeExample+'\')"><div class="small">EXAMPLE</div><div class="example-text">'+w.e+'</div><div class="example-ja">'+w.j+'</div></div></div></details>';
  }
